...
while True:
    ...
    if maxn.lower() and maxscore.lower() == 'q':
        quit()
...
# Tracking user guess position
        ...
        if user_guess == hidden_num and com_guess == hidden_num:
            ...
            print("ONE POINT for you and I"); time.sleep(0.5)
            user_win += 1
            com_win += 1
            break
        ...
        if user_guess == hidden_num and com_guess != hidden_num:
            ...
            print("ONE POINT for you"); time.sleep(0.5)
            user_win += 1
            break
